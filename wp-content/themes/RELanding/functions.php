...
function writer (){
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'enya.local')){
    ...
    //   wp_enqueue_style('my-style', get_theme_file_uri('/css/styles.css'), null, '1.0', 'all');
      wp_enqueue_style('my-style', get_theme_file_uri('/bundled-assets/styles.5ccb3ebcdf429860f1a7.css'), null, '1.0', 'all');
      wp_enqueue_script('our-vendors-js', get_theme_file_uri('/bundled-assets/vendors~scripts.90b159a0b75a722ad578.js'), NULL, '1.0', true);
      wp_enqueue_script('main-writer-scripts', get_theme_file_uri('/bundled-assets/scripts.5ccb3ebcdf429860f1a7.js'), NULL, '1.0', true);
    }
