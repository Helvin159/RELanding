...
function writer (){
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'enya.local')){
    ...
    //   wp_enqueue_style('my-style', get_theme_file_uri('/css/styles.css'), null, '1.0', 'all');
      wp_enqueue_style('my-style', get_theme_file_uri('/bundled-assets/styles.9cc48cee5eacb3f52024.css'), null, '1.0', 'all');
      // wp_enqueue_script('our-vendors-js', get_theme_file_uri('/bundled-assets/undefined'), NULL, '1.0', true);
      wp_enqueue_script('main-writer-scripts', get_theme_file_uri('/bundled-assets/scripts.9cc48cee5eacb3f52024.js'), NULL, '1.0', true);
    }
  ...
  // Popper
  wp_enqueue_script('popper', '//code.jquery.com/jquery-3.5.1.slim.min.js', NULL, '1.0', true);
  // Bootstrap JS
  wp_enqueue_script('bootsrap', '//cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js', NULL, '1.0', true);
}
